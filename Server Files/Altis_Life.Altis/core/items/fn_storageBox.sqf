...
if(count _containers >= (_houseCfg select 1)) exitWith {hintSilent "You cannot place any more storage containers in your house."};
...
if(_pos isEqualTo [0,0,0]) exitWith {hintSilent "No more free storage spaces in your house."};
