...
if(life_atmcash < _price) exitWith {hintSilent format[(localize "STR_Garage_CashError"),[_price] call life_fnc_numberText];};
...
hintSilent localize "STR_Garage_SpawningVeh";
